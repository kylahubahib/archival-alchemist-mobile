...
export default function FavoriteScreen() {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyStateContainer}>
      <Fontisto name="favorite" size={50} color="gray" /> 
      <Text style={styles.emptyStateText}>Favorite Manuscript Capstone will be added here.</Text>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Displaying books or empty state */}
      <FlatList
        data={favBooks}
